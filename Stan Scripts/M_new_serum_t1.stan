...
transformed parameters {
  ...
  for (i in 1:N) {
    ...
    sess_beta1[i] =  beta_nal_noise*naltrexone[i] + beta_ami_noise*amisulpride[i]+ beta_serum_ami_high_noise*serum_ami_high[i];
    sess_w[i] =  beta_nal*naltrexone[i] + beta_ami*amisulpride[i] + beta_serum_ami_high*serum_ami_high[i];
    sess_g[i] =  beta_nal_g*naltrexone[i] + beta_ami_g*amisulpride[i] + beta_serum_ami_high_g*serum_ami_high[i];
