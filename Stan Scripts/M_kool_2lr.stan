...
transformed parameters {
  ...
  for (i in 1:N) {
      ...
      a2[i]     = Phi_approx(a2_raw_t0[i] + sess_a2[i]  );
...
//  agent realizes transition structure:
  ...
  //     }
      ...
      v_2[state2[i,t]] =v_2[state2[i,t]] + a2[i]*(reward[i,t] - v_2[state2[i,t]] );
...
//  agent realizes transition structure:
  ...
  //     }
      ...
      // Update Level 2 v_mf of the chosen option. Level 2--> choose one of level 2 options and observe reward
      //    Q2(s2) = Q2(s2) + lr*dtQ(2);            
      v_2_t0[state2_t0[i,t]] =v_2_t0[state2_t0[i,t]] + a2_t0[i]*(reward_t0[i,t] - v_2_t0[state2_t0[i,t]] );
