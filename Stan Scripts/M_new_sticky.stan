...
transformed parameters {
  ...
  for (i in 1:N) {
    ...
    sess_beta1[i] = mu_p[4] + r1[4,i]   + beta_nal_noise*naltrexone[i] + beta_ami_noise*amisulpride[i];
    sess_w[i] =  mu_p[5] + r1[5,i]  + beta_nal*naltrexone[i] + beta_ami*amisulpride[i];
    sess_g[i] =   mu_p[6] + r1[6,i]  + beta_nal_g*naltrexone[i] + beta_ami_g*amisulpride[i];
    ...
    sess_rho[i] =   mu_p[8] + r1[8,i]  + beta_nal_rho*naltrexone[i] + beta_ami_rho*amisulpride[i];
    ...
    sess_pi[i] =   mu_p[10] + r1[10,i]  + beta_nal_pi*naltrexone[i] + beta_ami_pi*amisulpride[i];
